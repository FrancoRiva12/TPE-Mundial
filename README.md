...
* Administrar los partidos mediante un usuario administrador con permisos de creación, modificación y eliminación
...
El diagrama entidad-relación se encuentra incluido en el repositorio.
